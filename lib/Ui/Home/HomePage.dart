                                                              ...
                                                              if (state
                                                                ...
                                                                () async {
                                                                  ScaffoldMessenger.of(
                                                                          context)
                                                                      .showSnackBar(
                                                                          const MessengerSnack(message: "Image upload success")
                                                                              as SnackBar);
                                                                  Navigator.of(
                                                                          context)
                                                                      .pushReplacement(
                                                              ...
                                                              if (state
                                                                ...
                                                                () async {
                                                                  ScaffoldMessenger.of(
                                                                          context)
                                                                      .showSnackBar(
                                                                          MessengerSnack(message: state.error)
                                                                              as SnackBar);
                                                                  Navigator.of(
                                                                          context)
                                                                      .pushReplacement(
                                                                          ...
                                                                          input
                                                                            ...
                                                                            reader.onLoadEnd.listen((event) {
                                                                              BlocProvider.of<ImageUploadBloc>(context).add(
                                                                                UploadButtonPressed(image: files, path: files.name),
                                                                              );
                                                                            });
                                                                          });
                                                                        },
                                                                    ...
                                                                    FirebaseJob()
                                                                      ...
                                                                      job: Job(
                                                                        ...
                                                                        image: state
                                                                            .imageUrl,
                                                                        location:
                                                                            await SharedPreferencesManager().getUserLocation(),
                                                                        createdAt:
                                                                            Timestamp.now(),
                                                                        amount:
                                                                        ...
                                                                        belongsTo: FirebaseAuth
                                                                            ...
                                                                            .uid,
                                                                        userImage:
                                                                            await SharedPreferencesManager().getUserImage(),
                                                                        userName:
                                                                            await SharedPreferencesManager().getUserName(),
                                                                        userRole:
                                                                            await SharedPreferencesManager().getRole(),
                                                                      ),
                                                                      context:
                                                                          context,
                                                                    );
