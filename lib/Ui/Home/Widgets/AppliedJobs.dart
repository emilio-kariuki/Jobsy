...
import 'package:jobsy_flutter/Ui/Home/Widgets/AppliedJobsCard.dart';
...
class AppliedJobs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: FutureBuilder(
          future: FirebaseJob()
              .getAppliedJobs(userId: FirebaseAuth.instance.currentUser!.uid),
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: AppliedJobsCard(
                        appliedBy: docs[index].belongsTo,
