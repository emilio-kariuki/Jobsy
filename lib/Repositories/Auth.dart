    ...
    try {
      ...
      if (user != null) {
        FirebaseAuthentication().createUser(
          ...
          image: "https://firebasestorage.googleapis.com/v0/b/apt-rite-346310.appspot.com/o/profile.jpg?alt=media&token=71a31f30-11ee-49b9-913c-b3682d3f6ea7",
          location: "Nairobi, Kenya",
          role: "Developer",
          amountEarned: "0",
        ));
        await SharedPreferencesManager().setUserId(value: user.uid);
        await SharedPreferencesManager().setUserName(value: name);
        await SharedPreferencesManager().setUserEmail(value: email);
        await SharedPreferencesManager().setUserLocation(value: "home");
      }
      return true;
    } catch (e) {
